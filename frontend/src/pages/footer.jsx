    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto xl:max-w-[1440px] 2xl:max-w-[1720px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 md:mb-4">
          ...
          <div className="lg:col-span-1 flex flex-col items-start md:mb-4 lg:mb-0">
            ...
            <p className="text-sm" style={{ color: COLORS.accent }}>
              Crafting elegance with tradition. Discover timeless fashion
              inspired by culture.
            </p>
          </div>
          ...
          <div className="">
            <h3
              className="text-lg font-bold md:mb-3 flex items-center gap-2"
              style={{ color: COLORS.primary }}
            >
              Quick Links
            </h3>
            <ul
              className="grid grid-cols-2 md:grid-cols-1 gap-2 text-center"
            ...
            >
              ...
              <li>
                <Link
                  to="/contact"
                  className="hover:underline hover:text-[#B3541E] flex items-center md:gap-2 text-sm md:text-lg"
                >
                  Contact Us
                </Link>
              </li>
          ...
          <div>
            <h3
              className="text-lg font-bold mb-3 flex items-center md:gap-2 text-sm md:text-lg"
              style={{ color: COLORS.primary }}
            >
              Contact Us
            </h3>
          ...
          <div>
            ...
            <p
              className=" mb-1 md:mb-3 text-sm"
              style={{ color: COLORS.accent }}
            >
              {" "}
              {/* Adjusted text size */}
              Stay connected and get inspired by our latest designs & styling
              ideas:
            </p>
          ...
          <div>
            <h3
              className="text-lg font-bold md:mb-3 flex items-center justify-center gap-1 text-center "
              style={{ color: COLORS.primary }}
            >
              Disclaimer
            </h3>
            <p className="text-sm md:mb-4" style={{ color: COLORS.accent }}>
              All products and designs showcased on Tehzeeb Creations are
              created with utmost care and originality. <br />
              Colors may slightly vary due to photographic lighting or screen
              settings.
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            {" "}
            {/* Adjusted text size */}© 2025 Tehzeeb Creations. All Rights
            Reserved.
          </div>
          <div
            className="text-xs md:text-base"
          ...
          >
            ...
            <span style={{ color: COLORS.secondary }}></span> by TP India
            Network
          </div>
        </div>
      </div>
